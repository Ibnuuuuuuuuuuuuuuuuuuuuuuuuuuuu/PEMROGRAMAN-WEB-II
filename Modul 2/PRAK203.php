...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="radio" name="dari" value="celcius"
            <?php if (isset($dariSuhu) && $dariSuhu == "celcius") echo "checked"; ?>> Celcius<br>
        <input type="radio" name="dari" value="fahrenheit"
            <?php if (isset($dariSuhu) && $dariSuhu == "fahrenheit") echo "checked"; ?>> Fahrenheit<br>
        <input type="radio" name="dari" value="rheamur"
            <?php if (isset($dariSuhu) && $dariSuhu == "rheamur") echo "checked"; ?>> Rheamur<br>
        <input type="radio" name="dari" value="kelvin"
            <?php if (isset($dariSuhu) && $dariSuhu == "kelvin") echo "checked"; ?>> Kelvin<br>
        Ke :<br>
        <input type="radio" name="ke" value="celcius"
            <?php if (isset($keSuhu) && $keSuhu == "celcius") echo "checked"; ?>> Celcius<br>
        <input type="radio" name="ke" value="fahrenheit"
            <?php if (isset($keSuhu) && $keSuhu == "fahrenheit") echo "checked"; ?>> Fahrenheit<br>
        <input type="radio" name="ke" value="rheamur"
            <?php if (isset($keSuhu) && $keSuhu == "rheamur") echo "checked"; ?>> Rheamur<br>
        <input type="radio" name="ke" value="kelvin"
            <?php if (isset($keSuhu) && $keSuhu == "kelvin") echo "checked"; ?>> Kelvin<br>
