        ...
        for ($i=0; $i < count($nilai); $i++) {
            for ($j=0; $j < count($nilai[$i]["mk"]); $j++) { 
                ...
                if ($j == 0) {
                    ...
                    echo "<td>".$nilai[$i]["mk"][$j]["nama_mk"]."</td>";
                    echo "<td>".$nilai[$i]["mk"][$j]["sks"]."</td>";
                    echo "<td>".$nilai[$i]["totalSks"]."</td>";
                    if ($nilai[$i]["ket"] == "Revisi KRS"){
                        echo '<td style="background-color: red;">'.$nilai[$i]["ket"]."</td>";
                    } else {
                        echo '<td style="background-color: green;">'.$nilai[$i]["ket"]."</td>"; 
                    }
                } else {
                    echo "<td></td>";
                    echo "<td></td>";
